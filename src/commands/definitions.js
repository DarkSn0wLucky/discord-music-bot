...
const definitions = [
  new SlashCommandBuilder()
    .setName("play")
    .setDescription("Добавить трек по ссылке или поисковому запросу")
    .addStringOption((option) =>
      option.setName("query").setDescription("YouTube/SoundCloud ссылка или текст поиска").setRequired(true)
    ),
  ...
  new SlashCommandBuilder().setName("stop").setDescription("Остановить и очистить очередь"),
